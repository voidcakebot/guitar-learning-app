  ...
  return (
    <AppShell>
      <div className="space-y-8">
        <div className="card">
          <span className="badge">Library / explorer</span>
          <h1 className="mt-4 text-3xl font-semibold text-white">Canonical guitar knowledge</h1>
          <p className="mt-2 max-w-3xl text-slate-300">
            This content is seeded in code and shared across every learner. Personal state only starts once an entry is added to a profile.
          </p>
        </div>
        ...
        {Object.entries(grouped).map(([type, entries]) => (
          <section key={type} className="space-y-4">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-xl font-semibold capitalize text-white">{type}s</h2>

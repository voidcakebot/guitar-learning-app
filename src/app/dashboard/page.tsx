          ...
          <div className="space-y-6">
            ...
            <div className="card">
              ...
              {nextRecommended ? (
                ...
                <p className="mt-4 text-sm text-slate-400">You have already started everything in the current library.</p>
              )}
            </div>
          </div>
              ...
              <div className="mt-5 space-y-4">
                {data.learningItems.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-white/10 p-6 text-sm text-slate-400">
                    No learning items yet. Open the library and add something you want to practice.
                  </div>
                ) : (
